...
const sections = [
  ['Acceptance of Terms', 'By accessing and using Nova Clothing, you agree to be bound by these Terms & Conditions and all applicable laws and regulations.'],
  ...
  ['Intellectual Property', 'All content on this site — including images, text, and branding — is the property of Nova Clothing and may not be reproduced without permission.'],
];
